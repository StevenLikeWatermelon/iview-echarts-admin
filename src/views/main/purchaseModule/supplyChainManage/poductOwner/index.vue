            ...
            <Card>
                <Form :label-width="120"  :model="orderInfo" class="model-style">
                    <Row>
                        ...
                        <Col span="4">
                        <Input v-model="applyInfo.cpbh" placeholder="输入产品编号" @on-enter="search"></Input>
                        </Col>
                        <Col span="4">
                         <Input v-model="applyInfo.product_name" placeholder="输入产品名称" @on-enter="search"></Input>
                        </Col>
                        <Col span="4">
                        <Select v-model="applyInfo.purchaser" filterable @on-change="search">
                        ...
                        <FormItem label="备货员：">
                         ...
                         <Col span="4">
                        <Select v-model="applyInfo.manager" filterable @on-change="search">
                                <Option value="all">选择品牌经理</Option>
                                <Option value="unassign">未分配</Option>
            ...
            <col span="24">
                ...
                <div v-auth="buttonAuth">
                   <!--  <Select v-model="typeTmp.valid" style="float:left;width:120px;" @on-change="typeChange">
                    ...
                    <Button type="primary" @click="exportIn">分配负责人</Button>
                    <!-- <div class="clear"></div> -->
                </div>
                <el-table :row-class-name="tableRowClassName" :data="applyList" border style="text-align: center" @sort-change="manualSort" ref="multipleTable" @select="selectOne"  @select-all="selectAll" class="margin-top-10" max-height="570">
        ...
        <Modal v-model="exportInModal" :mask-closable=true :width="300" :closable=true>
            ...
            <Form class="content" :label-width="100">
                <Row>
                    <Col span="24">
                    <FormItem label="采购员：">
                        <Select v-model="applyOwner.purchaser" filterable v-if="exportInModal">
                            <Option v-for="status in buyers" :value="status.value" :key="status.value">{{ status.label }}</Option>
                        </Select>
                    </FormItem>
                    </Col>
...
<script>
    ...
    import { apiGetPurchaseProductUserList, operateAllBrandsList, allpersonInfos, apiGetPurchaseProductUserAssign} from '@/config/getData';
    ...
    export default {
        ...
        data () {
            return {
                buttonAuth: 'product_manage_button',
                applyInfo: {
                    brand: 'all',
                    series: '',
                    cpbh:'',
