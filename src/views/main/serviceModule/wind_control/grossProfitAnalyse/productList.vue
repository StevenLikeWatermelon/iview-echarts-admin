        ...
        <Row>
            ...
            <Card>
                <Form :model="orderInfo" :label-width="120"  class="model-style">
                    <Row>
                        <Col span="4">
                            <Input v-model="orderInfo.cpbh" placeholder="输入产品编号" @on-enter="search"></Input>
                        </Col>
                        <Col span="4">
                        ...
                        <Col span="4">
                            <Input v-model="orderInfo.cplbmc" placeholder="输入产品类别" @on-enter="search"></Input>
                        </Col>
                        <Col span="4">
        ...
        <Row class="margin-top-10 margin-pag-botm">
            ...
            <Card>
                ...
                <el-table :data="dataList"  ref="multipleTable" border style="text-align: center;width:100%" :row-class-name="tableRowClassName" @sort-change="manualSort" @select="selectOne"  @select-all="selectAll"   max-height="570">
                    ...
                    <el-table-column prop="cpbh" label="产品编号" min-width="120" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="cpmc" label="产品名称" sortable="custom" min-width="120" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="cpppmc" label="品牌" sortable="custom" min-width="100" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="cplbmc" label="产品类别" sortable="custom" min-width="120" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="cpmcty" label="通用系列" sortable="custom" min-width="120" show-overflow-tooltip></el-table-column>
...
<script type="text/ecmascript-6">
    ...
    import {apiAllStatus, getOutProfitProductApi, getOutProfitProductExporttApi, apiAllBrands } from '@/config/getData';
    ...
    export default {
        ...
        methods: {
            ...
            Export() {
                getOutProfitProductExporttApi(this, {
