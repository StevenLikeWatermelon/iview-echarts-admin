        ...
        <Row class="margin-top-10 margin-pag-botm">
            ...
            <Card>
                ...
                <el-table :data="dataList"  ref="multipleTable" border style="text-align: center;width:100%" :row-class-name="tableRowClassName" @sort-change="manualSort" @select="selectOne"  @select-all="selectAll"   max-height="570">
                    ...
                    <el-table-column prop="ckml_rebate" sortable="custom" label="出库毛利(扣除返点)" show-overflow-tooltip width="150"></el-table-column>
                    <el-table-column prop="ckmll_rebate" sortable="custom" label="出库毛利率(扣除返点)" show-overflow-tooltip width="170"></el-table-column>
                    <el-table-column prop="ship_amount" label="运费" show-overflow-tooltip width="110"></el-table-column>
                    <el-table-column prop="ckmc" label="出库仓库" sortable="custom" show-overflow-tooltip width="200"></el-table-column>
...
<script type="text/ecmascript-6">
    ...
    import { allStoreInfos, apiAllStatus, apiGetDepart, apiGetAllSalesman, apiGetAllServiceMan, getOutProfitListApi, getOutProfitLisExporttApi } from '@/config/getData';
    ...
    export default {
        ...
        methods: {
            ...
            Export() {
                getOutProfitLisExporttApi(this, {
