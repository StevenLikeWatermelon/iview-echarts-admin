        ...
        <Row>
            ...
            <Card>
                <Form :model="orderInfo" :label-width="120"  class="model-style">
                    <Row>
                        <Col span="4">
                            <Input v-model="orderInfo.cpxhbh" placeholder="请输入商品型号编号" @on-enter="search"></Input>
                        </Col>
                        <Col span="4">
                        ...
                        <Col span="4">
                            <Input v-model="orderInfo.cpxh" placeholder="输入商品型号" @on-enter="search"></Input>
                        </Col>  
                        <Col span="4">
        ...
        <Row class="margin-top-10 margin-pag-botm">
            ...
            <Card>
                ...
                <el-table :data="dataList"  ref="multipleTable" border style="text-align: center;width:100%" :row-class-name="tableRowClassName" @sort-change="manualSort" @select="selectOne"  @select-all="selectAll"   max-height="570">
                    ...
                    <el-table-column prop="cpxhbh" label="商品型号编号" min-width="150" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="cpdhh" label="订货号" sortable="custom" min-width="120" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="cpxh" label="商品型号" sortable="custom" min-width="120" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="cpppmc" label="品牌" sortable="custom" min-width="120" show-overflow-tooltip></el-table-column>
...
<script type="text/ecmascript-6">
    ...
    import {apiAllStatus, getOutProfitGoodsApi, getOutProfitGoodsExporttApi, apiAllBrands } from '@/config/getData';
    ...
    export default {
        ...
        methods: {
            ...
            Export() {
                getOutProfitGoodsExporttApi(this, {
