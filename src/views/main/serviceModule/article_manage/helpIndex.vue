        ...
        <Row class="margin-top-10 margin-pag-botm">
            ...
            <Card>
                <Col span="24" style="margin-bottom: 10px;">
                    <Button v-show="!isEdit" type="primary" v-auth="help_add_auth" @click="add">新建</Button>
                    <Button v-show="!isEdit" type="primary" v-auth="help_edit_auth" @click="edit">编辑</Button>
                    <Button v-show="isEdit" type="primary" v-auth="help_edit_auth" @click="editSave">保存</Button>
                    <Button v-show="isEdit" type="primary" v-auth="help_edit_auth" @click="editCancel">取消</Button>
                    <Button v-show="!isEdit" type="primary" v-auth="help_del_auth" @click="del">删除</Button>
                </Col>
...
<script type="text/ecmascript-6">
    ...
    export default { 
        data () {
            return {
                help_add_auth:"help_add_auth",
                help_edit_auth:"help_edit_auth",
                help_del_auth:"help_del_auth",
                isEdit:false,
                info: {
                    column_no: 'all',
                    title: '',
        ...
        methods: {
            ...
            handleClick (param, path) {
                util.openNewPage(this, path, {id:param,type:2});
                this.$router.push({
                    name: path,
                    query: {id:param,type:2}
                });
            },
            changeDatetime (time) {
