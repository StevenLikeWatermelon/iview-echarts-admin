        ...
        <Row class="margin-top-10 margin-pag-botm">
            ...
            <Card>
                <Col span="24" style="margin-bottom: 10px;">
                    <Button v-show="!isEdit" type="primary" v-auth="announce_add_auth" @click="add">新建</Button>
                    <Button v-show="!isEdit" type="primary" v-auth="announce_edit_auth" @click="edit">编辑</Button>
                    <Button v-show="isEdit" type="primary" v-auth="announce_edit_auth" @click="editSave">保存</Button>
                    <Button v-show="isEdit" type="primary" v-auth="announce_edit_auth" @click="editCancel">取消</Button>
                    <Button v-show="!isEdit" type="primary" v-auth="announce_del_auth" @click="del">删除</Button>
                </Col>
...
<script type="text/ecmascript-6">
    ...
    export default { 
        data () {
            return {
                announce_add_auth:"announce_add_auth",
                announce_edit_auth:"announce_edit_auth",
                announce_del_auth:"announce_del_auth",
                isEdit:false,
                info: {
                    column_no: 'all',
                    title: '',
        ...
        methods: {
            ...
            handleClick (param, path) {
                util.openNewPage(this, path, {id:param,type:1});
                this.$router.push({
                    name: path,
                    query: {id:param,type:1}
                });
            },
            changeDatetime (time) {
