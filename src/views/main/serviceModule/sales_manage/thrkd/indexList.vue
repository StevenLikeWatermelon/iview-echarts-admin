            ...
            <Card>
                <Form :model="orderInfo" :label-width="120" class="model-style">
                    <Row>
                        ...
                        <Col span="4">
                        <Input v-model="orderInfo.sell_order_no" placeholder="退货申请单编号" @on-enter="search"></Input>
                        </Col>
                        <Col span="4">
        ...
        <Row class="margin-top-10 margin-pag-botm">
            ...
            <Card>
                <el-table :data="orderData.data" border stripe style="text-align: center" @sort-change="manualSort"  max-height="570">
                    ...
                    <el-table-column prop="return_no" label="销售退货单编号">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="sell_order_no" label="销售合同单编号">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="store_name" label="入库仓库" show-overflow-tooltip></el-table-column>
                    ...
                    <el-table-column prop="contact_method" label="联系方式"  show-overflow-tooltip></el-table-column>
                    <el-table-column prop="instock_status" label="单据状态">
                        <template slot-scope="scope">
...
<script type="text/ecmascript-6">
    ...
    import { apiAllStatus,apithrkdList,apiGetAllServiceMan,apiGetAllSalesman } from '@/config/getData';
