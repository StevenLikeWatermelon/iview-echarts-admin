    ...
    <div>
            ...
            <Card>
                ...
                <div>
                    <div class="margin-bottom-10">
                        ...
                        <span class="margin-left-20">取消商品总额： <em style="color:#cf0012;font-style: normal;">{{ goodsAllMoney }}</em></span>
                    </div>
                    <el-table :data="ckdList.data" border stripe style="text-align: center"  @sort-change="manualSort">
                        ...
                        <el-table-column prop="ckdj" label="可取消数量" sortable="custom" min-width="100"></el-table-column>
                        <el-table-column prop="ckdj" label="本次取消数量" sortable="custom">
                            <template slot-scope="scope">
                                <Input type="text" v-model="scope.row.ckdj" ></Input>
                            </template>
                        </el-table-column>
                        <el-table-column prop="ckje" label="取消金额" sortable="custom" min-width="100">
                            <template slot-scope="scope">
        ...
        <Row style="position: fixed;text-align: center;left: 0;bottom: 0;width: 100%;z-index: 888;">
            ...
            <Card>
                ...
                <Button type="primary" class="margin-top-10" style="margin:auto;margin-left:30px;" :loading="loadding" @click="save">保存</Button>
            </Card>
            </Col>
        </Row>
        <!--弹框公用-->
