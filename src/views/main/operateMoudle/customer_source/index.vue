<template>
    <div style="position: relative" class="diy-opcity">
        ...
        <Row class="margin-top-10">
            ...
            <Card>
                ...
                <el-table :data="dataList" border stripe style="text-align: center" @sort-change="manualSort">
                    <el-table-column prop="khlybh" label="客户来源编号" ></el-table-column>
                    <el-table-column prop="khlymc" label="客户来源名称" show-overflow-tooltip></el-table-column>
                    ...
                    <el-table-column prop="operation" label="操作" >
                        <template slot-scope="scope">
                            ...
                            <span class="span-for-click" style="margin-left:10px;" @click="action('del', scope.row.khlybh)">删除</span>
                        </template>
                    </el-table-column>
        ...
        <Modal v-model="showAdd" title="客户来源" class="modal-margin">
            <Form ref="AddSourceObj" :model="AddSourceObj" :label-width="100" :show-message="false" >
                <FormItem prop="khlymc"  label="客户来源名称：">
                    <Input v-model="AddSourceObj.khlymc" placeholder="请输入客户来源名称" style="width:200px;"></Input>
                    <!--<input type="text" v-model="AddSourceObj.khlymc" style="width:200px;">-->
                </FormItem>
        ...
        <Modal v-model="showEdit" title="客户来源" class="modal-margin">
            <Form ref="EditSourceObj" :model="EditSourceObj" :label-width="100" :show-message="false" >
                <FormItem prop="khlymc"  label="客户来源名称：">
                    <Input v-model="EditSourceObj.khlymc" placeholder="请输入客户来源名称" style="width:200px;"></Input>
                    <!--<input type="text" v-model="EditSourceObj.khlymc" style="width:200px;">-->
                </FormItem>
                <FormItem prop="bz" label="备注：">
...
<script type="text/ecmascript-6">
    import { apiCustomerSource,apiAddSource,apiEditSource,apiDelSource } from '@/config/getData';
    ...
    export default {
        ...
        methods: {
            ...
            confirm() {
                ...
                apiAddSource(this, {
                    params: JSON.stringify({
                        khlymc: this.AddSourceObj.khlymc,
            ...
            action(type,val) {
                ...
                if(type == 'edit'){
                    this.EditSourceObj.khlymc = val.khlymc;
                    this.EditSourceObj.bz = val.bz;
                    this.EditSourceObj.khlybh = val.khlybh;
                    this.showEdit = true;
                }
                else if(type == 'del'){
                    this.publicSure = 'del';
            ...
            confirmEdit() {
                apiEditSource(this, {
                    params: JSON.stringify({
                        khlybh: this.EditSourceObj.khlybh,
                        khlymc: this.EditSourceObj.khlymc,
