<template>
    <div style="position: relative" class="diy-opcity">
        ...
        <Row class="margin-top-10">
            ...
            <Card>
                ...
                <el-table :data="dataList" border stripe style="text-align: center" @sort-change="manualSort">
                    <el-table-column prop="khdjbh" label="客户等级编号" width="150"></el-table-column>
                    <el-table-column prop="khdjmc" label="客户等级名称" show-overflow-tooltip></el-table-column>
                    ...
                    <el-table-column prop="operation" label="操作" width="200">
                        <template slot-scope="scope">
                            ...
                            <span class="span-for-click" style="margin-left:10px;" @click="action('del', scope.row.khdjbh)">删除</span>
                        </template>
                    </el-table-column>
        ...
        <Modal v-model="showAdd" title="客户等级" class="modal-margin">
            <Form ref="AddSourceObj" :model="AddSourceObj" :label-width="100" :show-message="false" >
                <FormItem prop="khdjmc"  label="客户等级名称：">
                    <Input v-model="AddSourceObj.khdjmc" placeholder="请输入客户等级名称" style="width:200px;"></Input>
                    <!--<input type="text" v-model="AddSourceObj.khdjmc" style="width:200px;">-->
                </FormItem>
        ...
        <Modal v-model="showEdit" title="客户等级" class="modal-margin">
            <Form ref="EditSourceObj" :model="EditSourceObj" :label-width="100" :show-message="false" >
                <FormItem prop="khdjmc"  label="客户等级名称：">
                    <Input v-model="EditSourceObj.khdjmc" placeholder="请输入客户等级名称" style="width:200px;"></Input>
                    <!--<input type="text" v-model="EditSourceObj.khdjmc" style="width:200px;">-->
                </FormItem>
                <FormItem prop="bz" label="备注：">
...
<script type="text/ecmascript-6">
    import { apiCustomerGrade,apiAddGrade,apiEditGrade,apiDelGrade } from '@/config/getData';
    ...
    export default {
        ...
        methods: {
            ...
            confirm() {
                ...
                apiAddGrade(this, {
                    params: JSON.stringify({
                        khdjmc: this.AddSourceObj.khdjmc,
            ...
            action(type,val) {
                ...
                if(type == 'edit'){
                    this.EditSourceObj.khdjmc = val.khdjmc;
                    this.EditSourceObj.bz = val.bz;
                    this.EditSourceObj.khdjbh = val.khdjbh;
                    this.showEdit = true;
                }
                else if(type == 'del'){
                    this.publicSure = 'del';
            ...
            confirmEdit() {
                apiEditGrade(this, {
                    params: JSON.stringify({
                        khdjbh: this.EditSourceObj.khdjbh,
                        khdjmc: this.EditSourceObj.khdjmc,
