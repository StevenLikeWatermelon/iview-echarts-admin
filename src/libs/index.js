...
function createLionFn(){
  lion = new Lion();
  scene.add(lion.threegroup);
}

function createFanFn(){
  fan = new Fan();
...
export const createLights = createLightsFn;
export const createFloor = createFloorFn;
export const createLion = createLionFn;
export const createFan = createFanFn;
